window.onload = function() {
  ...
  function displayFavPlace(response){
      console.log("response in display fav", response);
        ...
        for(var key in resI){
          ...
          switch (key) {
            case "name":
              ...
              backgrounds2.appendChild(view);
              p.innerHTML = name;
              backgrounds2.appendChild(p);
